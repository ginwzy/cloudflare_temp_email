...
api.get('/admin/user_management', admin_user_api.getUsers)
api.delete('/admin/user_management/:user_id', admin_user_api.deleteUser)
api.post('/admin/user_management', admin_user_api.createUser)
api.post('/admin/user_management/:user_id/reset_password', admin_user_api.resetPassword)
...
api.get('/admin/user_management/bind_address/:user_id', admin_user_api.getBindedAddresses)
api.post('/admin/user_management/bind_address', admin_user_api.bindAddress)
